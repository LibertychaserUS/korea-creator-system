...
export const en: Locale = {
  ...
  kcs: {
    ...
    metricHelp: {
      followers: "Cumulative followers displayed on Xiaohongshu profile. From Pugongying or vendor data, shown as — if unavailable.",
      followerGrowth: "Net followers gained in the statistical window. From Pugongying or vendor data, shown as — if unavailable.",
      followerGrowthRate: "Net follower gain ÷ followers at the start of window. Derived ratio, shown as — if unavailable.",
      readFanRatio: "Share of reads originating from following fans; lower indicates stronger organic discovery reach. From Pugongying official field, shown as — if unavailable.",
      activeFanRatio: "Share of followers with active browsing habits in the last 30 days. From Pugongying official field, shown as — if unavailable.",
      engagedFanRatio: "Share of followers interacting (likes, saves, comments) in the last 30 days. From Pugongying official field, shown as — if unavailable.",
      impressionMedian: "Median organic feed impressions per post in the window. From Pugongying or vendor data, shown as — if unavailable.",
      readMedian: "Median organic reads per post in the window. From Pugongying or vendor data, shown as — if unavailable.",
      interactionMedian: "Median sum of likes, saves, and comments per post. From Pugongying or vendor data, shown as — if unavailable.",
      likeMedian: "Median likes per post. From Pugongying or vendor data, shown as — if unavailable.",
      collectMedian: "Median saves per post, reflecting strong buyer intent and product interest. From Pugongying or vendor data, shown as — if unavailable.",
      commentMedian: "Median comments per post. From Pugongying or vendor data, shown as — if unavailable.",
      coopReadMedian: "Median reads on official Pugongying commercial sponsored posts. From Pugongying official field, shown as — if unavailable.",
      coopInteractionMedian: "Median interactions on official Pugongying commercial sponsored posts. From Pugongying official field, shown as — if unavailable.",
      engagementRate: "Median interactions ÷ median reads (calculated against real reads, not fan count). Derived ratio, shown as — if unavailable.",
      retentionRate: "3-second read rate for images or 5-second completion rate for videos. From Pugongying or vendor data, shown as — if unavailable.",
      noteCount: "Total public posts published in the statistical window. From Pugongying or vendor data, shown as — if unavailable.",
      viralCount: "Number of viral posts achieving ≥1,000 or ≥5,000 likes in the window. From vendor data, shown as — if unavailable.",
      viralRate: "Viral posts ÷ total posts. From Pugongying or vendor data, shown as — if unavailable.",
      priceImage: "Official Pugongying quote for a sponsored image post (CNY). From Pugongying official field, shown as — if unavailable.",
      priceVideo: "Official Pugongying quote for a sponsored video post (CNY). From Pugongying official field, shown as — if unavailable.",
      cpv: "Quote ÷ sponsored median reads. Derived division, shown as — if unavailable.",
      cpe: "Quote ÷ sponsored median interactions (industry benchmark typically ≤ 3 CNY for beauty). Derived division, shown as — if unavailable.",
      cpm: "Quote ÷ sponsored median reads × 1,000. Derived division, shown as — if unavailable.",
      collectLikeRatio: "Median saves ÷ median likes; higher ratio indicates high-value reference content. Derived ratio, shown as — if unavailable.",
      purchaseIntentCommentRatio: "Share of comments asking for purchase links, prices, or shades. From Pugongying semantic analysis, shown as — if unavailable.",
      trafficSearchRatio: "Share of reads originating from search; higher indicates durable long-tail intent. From Pugongying traffic structure, shown as — if unavailable.",
      trafficRecommendRatio: "Share of reads originating from Explore/recommendation feed. From Pugongying traffic structure, shown as — if unavailable.",
      trafficFollowRatio: "Share of reads originating from followers tab. From Pugongying traffic structure, shown as — if unavailable.",
      readToFollowerRatio: "Median reads ÷ followers; high ratio indicates algorithmic promotion and breakout reach. Derived ratio, shown as — if unavailable.",
      authenticity: "Estimated percentage of authentic followers sampled by third-party vendors. From vendor data, shown as — if unavailable.",
      coopNoteCount: "Total cumulative disclosed commercial sponsored posts on Xiaohongshu. From Pugongying official field, shown as — if unavailable."
    },
    metricGroup: {
      scale: "Scale",
      reach: "Reach",
    ...
    band: {
      ...
      lower: "Lower half in cohort (P25–P50)",
      bottom: "Bottom tier in cohort (< P25)",
      none: "Insufficient cohort data"
    },
    source: {
      label: "Source",
      ...
      official: "Official",
      vendor: "Vendor",
      fixture: "Sample data (fixture)",
      live: "Live data",
      configured: "Credentials configured",
      notConfigured: "No credentials",
      fetchedAt: "Fetched at",
      locked: "Immutable snapshot at publish"
    },
    query: {
      title: "Saved queries",
      lead: "A saved query is a structured specification: follower tier, health grade gate, metric thresholds, percentile bands, and sorting. Saved once, reused team-wide.",
      new: "New query",
      ...
      reset: "Reset",
      close: "Collapse",
      filters: "Metric conditions",
      addFilter: "Add condition",
      removeFilter: "Remove",
      noFilters: "No metric conditions set — filtering only by follower tier and health grade.",
      op: { gte: "≥", lte: "≤", between: "Between", percentileGte: "Cohort percentile ≥" },
      value: "Value",
      from: "From",
      to: "To",
      sort: "Sort",
      ...
      desc: "Descending",
      columns: "Columns",
      highlights: "Highlight thresholds",
      ...
      anyHealth: "Any",
      matched: "{n} matched",
      noResult: "No creators match this query",
      version: "v{n}",
      saved: "Saved",
      deleted: "Deleted",
      confirmDelete: "Delete this query?",
      errors: {
        "name.required": "Give the query a name",
        "filters.between": "Range start cannot exceed the end",
        "filters.value": "Invalid condition value",
        "filters.percentile": "Percentile must be between 0 and 100",
        "columns": "Show at least one column"
      }
    },
    ingest: {
      ...
      adapters: "Adapters",
      route: "Route",
      supports: "Supported parameters",
      provides: "Provided fields",
      credentials: "Credential variables",
      fetchTitle: "New fetch job",
      ...
      done: "Fetch completed: {written} written, {skipped} skipped, {failed} failed",
      fixtureNote: "No credentials configured for this source; the job returns standard sample data (fixture) to verify field mappings and UI layout.",
      jobs: "Fetch history",
      ...
      jobFailed: "Failed",
      jobTime: "Time",
      noJobs: "No fetch jobs recorded",
      rawTitle: "Raw response",
      rawLead: "Original platform JSON is stored verbatim to audit and reconcile field mappings.",
      transform: "Transform layer",
      transformLead: "One field-mapping table per source. Adjust mappings without touching core code."
    },
    landing: {
      ...
      workspacesLead: "Ops intakes and schedules jobs, Select filters creators by saved query, Dev monitors queues and quotas. Distinct roles, unified underlying snapshot.",
      ...
      steps: [
        ...
        { title: "Fetch", body: "Configure parameters to ingest JSON from Pugongying / Qiangua / Xinhong, normalised into uniform metrics." },
        { title: "Assign", body: "Selectors filter, sort, check, and assign creators to project shortlists with one click." },
        { title: "Monitor", body: "Track queued jobs, quota exhaustion cursors, and retries on a single dashboard." }
      ],
      dataEyebrow: "Data integrity",
      dataTitle: "Objective platform metrics. Zero weighted black box.",
      dataLead: "No arbitrary scoring formulas. Every metric traces directly to Pugongying official gateways or Qiangua/Xinhong enterprise endpoints; derived metrics are basic arithmetic ratios. Creator performance is evaluated solely via percentile ranking within the same data source and follower tier. Missing values remain '—'.",
      sourcesTitle: "Two direct routes, one transform layer",
      sources: {
        pugongying: { label: "Pugongying · Xiaohongshu official", body: "Direct connection via official or enterprise gateways returning solar protocol: median impressions/reads/interactions, engagement rate, reads from fans, quotes, CPE, health grade, audience demographics, and brand history." },
        qiangua: { label: "Qiangua · Enterprise vendor", body: "Enterprise API: Qiangua index, 90-day viral post performance, publishing frequency, follower growth consistency, and authenticity sampling." },
        xinhong: { label: "Xinhong · Enterprise vendor", body: "Campaign analysis data: empirical image/video CPE, CPM, Xinhong index, and organic search/recommendation traffic breakdown." }
      },
      ...
      tierTitle: "Compared within cohort",
      tierBody: "Head ≥ 500K, Mid 50K – 500K, Junior 5K – 50K, Amateur 300 – 5K. Percentiles are strictly computed within the same follower tier and data source. Cross-source comparison is prohibited.",
      gateTitle: "Health grade is a hard gate",
      gateBody: "Updated by Pugongying on the 1st of each month. An abnormal rating (low-activity creator) triggers immediate exclusion and is never diluted by metric weighting.",
      transformTitle: "Transform layer & raw JSON",
      transformBody: "Configurable field mapping per source with raw platform JSON stored verbatim. Update business definitions in mapping tables without altering application logic.",
      values: [
        { title: "No synthetic composite scores", body: "Display objective platform metrics directly. Good or bad is determined solely by relative percentile ranking in cohort." },
        { title: "Immutable snapshots at publish", body: "Each ingest preserves historical snapshots. Publishing locks metrics, ensuring delivered shortlists remain permanent and auditable." },
        { title: "Role-based workspaces via TinyShip", body: "Authenticated via TinyShip (better-auth); platform admin, ops, devops, and selectors access dedicated desks." }
      ],
    ...
    brand: {
      ...
      story: "Powered by parameterised crawlers, standard transform layer, and cohort percentile benchmarking. Connected to Pugongying and vendor sources to deliver transparent, objective influencer selection for cross-border brands.",
      eyebrow: "Cross-Border Creator Intelligence",
      pillars: "Data Sources · Saved Queries · Project Assignment · Monitoring",
      loginAside: "Single identity system. Access granted according to assigned organizational role.",
      storyExcerpt: "Return to objective platform metrics. Filter creators by structured queries and cohort percentiles.",
    ...
    panel: {
      ...
      noAudience: "This data source does not provide audience demographics",
      collabBrands: "Collaborated brands",
      chooseImage: "Choose image",
      imageHint: "PNG / JPG, square recommended.",
      stepSaveHint: "Fill in the display name to save draft.",
      learnMore: "Explore workspaces",
      mobileHint: "Rotate screen or switch to desktop for the full table view.",
      showAll: "Show all",
      clearFilters: "Clear filters",
      signOut: "Sign out",
      kpiHint: "Based on active pool",
      openRate: "Normalisation rate",
      today: "Today",
      overview: "Overview",
      quickActions: "Quick actions",
      recentActivity: "Recent activity",
      jobDistribution: "Task status breakdown",
      untitled: "Untitled",
      preview: "Preview",
      formHint: "Saving generates a creator key in draft status; publish locks metrics snapshot.",
      ...
      sources: "Data sources",
      batch: "Batch",
      poolLead: "Displays published active creators only; metrics and cohort percentiles are derived via the transform layer and stay immutable across language changes.",
      ...
      jobStatus: {
        ...
        queued: "Queued",
        failed: "Failed",
        partial: "Partial (quota reached, cursor saved)"
      },
      assignmentStatus: {
        assigned: "Assigned",
        removed: "Removed"
      ...
      signIn: "Sign in",
      signInLead: "Sign in with your corporate email to access your role-based workspace.",
      email: "Email",
      password: "Password",
      enter: "Enter",
      loginError: "Invalid email or password. Please verify your credentials.",
      homeLead: "Ops intake, selection filtering, and DevOps monitoring share one objective transform layer and metric snapshot repository.",
      opsDesc: "Creator intake, data source ingest dispatching, and category configuration.",
      selectDesc: "Filter creators with saved queries, manage projects, and assign candidate shortlists.",
      devDesc: "Monitor ingest queues, retry failed jobs, and audit data source connectivity and health.",
      openOps: "Go to Ops Desk",
      openSelect: "Go to Select Desk",
      openDev: "Go to Dev Desk",
      denied: "Access denied",
      deniedBody: "Your current account role does not have permission to view this workspace. Contact platform admin.",
      opsHome: "Ops Desk",
      ...
      scoreLocked: "Snapshot locked upon publishing; UI and subsequent ingests cannot overwrite it.",
      draft: "Draft",
      ...
      emptyBatches: "No import batch records found.",
      projects: "Projects",
      ...
      pool: "Creator pool",
      emptyPool: "No creators currently available in the pool. Ingest from sources or add manually in Ops.",
      emptyFilter: "No creators matched current filters or query conditions. Adjust thresholds or reset filter.",
      filter: "Filter",
      sort: "Sort",
      export: "Export",
      ...
      pipeline: "Pipeline",
      recommended: "Query recommendations",
      library: "Creator pool",
      sampleData: "Sample data (fixture)",
      rulePack: "Query pack",
      visibleFields: "Visible columns",
      weights: "Weights (deprecated)",
      defaultSort: "Default sort",
      advice: "Selection guidance",
    ...
    toolbar: {
      ...
      ruleFirst: "Objective metrics. Structured queries. Human verification."
    },
    overview: {
      eyebrow: "Saved query",
      title: "Screen creators by query",
      lead: "Metrics and percentile bands stem directly from data sources and the transform layer, free of weighted scores.",
    ...
    creators: {
      ...
      search: "Search by nickname or Xiaohongshu ID",
      emptyTitle: "No matching creators found",
      emptyBody: "Reset filter criteria to view the full creator pool.",
      cols: {
        rank: "Rank",
        creator: "Creator",
        score: "Metric value",
    ...
    reviews: {
      ...
      lead: "Assessment rationale grounded in objective platform metrics and cohort percentiles. Switching language alters UI text only without recalculating snapshots.",
      ...
      alignment: {
        hard_conflict: "Hard gate exclusion (abnormal)",
        soft_divergence: "Metric deviation alert",
        consistent: "Meets criteria",
        unknown: "Unknown"
      },
      fields: {
        reason: "Rationale",
        risk: "Risk assessment",
        alignment: "Query compliance"
      }
    },
    manual: {
      recommend: "Confirmed",
    ...
    exempt: {
      note: "Nickname, Xiaohongshu ID, raw keywords, and handwritten notes stay in the source language."
    }
  }
} as const; 