...
export const en: Locale = {
  ...
  kcs: {
    ...
    metricHelp: {
      ...
      readFanRatio: "Share of reads originating from followers. Lower indicates stronger public reach. Provided by Pugongying; shown as — if unavailable.",
      ...
      retentionRate: "3-second image read rate or 5-second video completion rate. Provided by Pugongying or partner platforms; shown as — if unavailable.",
      ...
      cpv: "Quote ÷ sponsored median reads. Cost per real read. Calculated by system; shown as — if unavailable.",
      cpe: "Quote ÷ sponsored median interactions. Cost per interaction. Calculated by system or Pugongying; shown as — if unavailable.",
      cpm: "Quote ÷ sponsored median reads × 1,000. Cost per 1,000 reads. Calculated by system; shown as — if unavailable.",
      ...
      readToFollowerRatio: "Median reads ÷ followers. Higher indicates strong feed recommendation. Calculated by system; shown as — if unavailable.",
    ...
    band: {
      legend: "Colour = ranking among peers of the same platform and tier; dot = highlight alert",
      cohort: "Comparing {n} {tier} creators on {source}",
      top10: "Top 10% on this platform & tier",
      top25: "Top 25% on this platform & tier",
      upper: "Upper half on this platform & tier (Top 25%–50%)",
      lower: "Lower half on this platform & tier (Bottom 25%–50%)",
      bottom: "Bottom bracket on this platform & tier (Bottom 25%)",
