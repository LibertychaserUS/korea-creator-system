...
export const en: Locale = {
  ...
  kcs: {
    landing: {
      ...
      previewMeta: "Released · sorted by score",
      previewCols: { creator: "Creator", grade: "Grade", score: "Score", fans: "Followers" },
      ...
      steps: [
        ...
        { title: "Score", body: "A rule engine weighs six dimensions into S / A / B / C. Locked on publish." },
      ...
      scoringTitle: "Scored by rules, not by gut.",
      scoringLead: "Every creator's score is a weighted sum of six dimensions, minus risk deductions, capped at 100. Rules are versioned; every score is traceable.",
      dims: {
        screening: { label: "Reach", body: "Follower tier" },
        keywords: { label: "Content", body: "Content keyword hits" },
        koreaBrand: { label: "Korea & brands", body: "Korean region and brand affinity" },
        potential: { label: "Potential", body: "Reach × history × output" },
        performance: { label: "Performance", body: "Engagement rate, median reads" },
        value: { label: "Value", body: "Quote per thousand followers" }
      },
      gradesTitle: "Grades",
      gradeS: "85 and up — reach out first",
      gradeA: "75 – 84 — core candidates",
      gradeB: "65 – 74 — fill as needed",
      gradeC: "Below 65 — park for now",
      riskTitle: "Risk deductions",
      riskBody: "Missing persona, missing tags, low collaboration ER, high quote, excluded type — up to 10 points off.",
      ruleVersion: "Rule version",
      values: [
        { title: "No chasing noise", body: "Scores come from rules, not from whoever shouts loudest." },
        { title: "Publish once", body: "Publishing locks the score. Nothing on the page can move it." },
