...
export const en: Locale = {
  ...
  kcs: {
    ...
    metricHelp: {
      ...
      readToFollowerRatio: "Median everyday reads ÷ followers: how many times the follower count a post is typically read. Higher means the platform is pushing it further. Calculated by system; shown as — if unavailable.",
