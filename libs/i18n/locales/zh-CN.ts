...
export const zhCN: Locale = {
  ...
  kcs: {
    ...
    metricHelp: {
      ...
      readFanRatio: "日常笔记的阅读里，来自已关注粉丝的比例。常见在两到四成之间；只作描述，不排位。由蒲公英提供；平台没给时显示 —。",
      activeFanRatio: "近 28 天内在小红书上有打开、浏览等动作的粉丝比例。由蒲公英提供；平台没给时显示 —。",
      ...
      retentionRate: "图文看 3 秒阅读率（打开后停留满 3 秒的阅读占比），视频看完播率。两者现在放在同一栏，图文博主和视频博主不要直接比。由蒲公英或合作平台提供；平台没给时显示 —。",
      noteCount: "统计周期内在小红书公开发布的笔记总数。由小红书或合作平台提供；平台没给时显示 —。",
      viralCount: "各平台对爆文的定义不同：蒲公英按千赞笔记算；千瓜按 12 小时内点赞过千或累计点赞过五千算；新红没有公开定义。不同来源的爆文数不能直接比。平台没给时显示 —。",
      viralRate: "爆文数 ÷ 发文数。发文少于 5 篇时数字不稳；各平台爆文定义不同，不能跨来源比较。由系统换算；平台没给时显示 —。",
      priceImage: "蒲公英报备官方图文合作单篇标准报价（人民币）。由蒲公英提供；平台没给时显示 —。",
      priceVideo: "蒲公英报备官方视频合作单篇标准报价（人民币）。由蒲公英提供；平台没给时显示 —。",
      cpv: "报价 ÷ 合作笔记阅读中位数，每次阅读的花费。按标价估算，不含服务费。由系统换算；平台没给时显示 —。",
      cpe: "按标价估算的每次互动花费，是投放前的预估；不含平台服务费（普通 10%、优效 20%），实际花费通常更高。由系统换算或蒲公英提供；平台没给时显示 —。",
      cpm: "有两种算法：蒲公英给的是每千次曝光的花费；千瓜和本系统算的是每千次阅读的花费。同一位博主两种数字可能差一倍，比较前先看来源。不含服务费。平台没给时显示 —。",
      ...
      readToFollowerRatio: "日常阅读中位数 ÷ 粉丝数，阅读大约是粉丝的几倍。由系统换算；平台没给时显示 —。",
    ...
    health: {
      ...
      abnormal: "异常",
      unknown: "未评级",
      hint: "小红书官方每月 1 日评定，只有「健康」「异常」两级，依据违规、刷量、未报备和履约情况；「异常」不建议合作。低活跃另外标注，和健康等级无关。",
      healthy: "健康",
      lowActive: "低活跃",
      lowActiveHint: "近期发文或互动偏少。这是另一项提示，和健康等级无关。"
    },
    band: {
      legend: "数字颜色 = 在本库已收录、同来源、同量级博主里的位置，不是全平台排名；圆点 = 方案高亮提醒",
      cohort: "本库已收录的 {source} {tier}博主 {n} 位里的位置，不是全平台排名；不足 30 位仅供参考",
      top10: "本库同来源同量级前 10%",
      top25: "本库同来源同量级前 25%",
      upper: "本库同来源同量级中上（前 25%–50%）",
      lower: "本库同来源同量级中下（后 25%–50%）",
      bottom: "本库同来源同量级末段（后 25%）",
      none: "本库同类人数较少，暂不排位"
    },
    source: {
      label: "数据源",
    ...
    landing: {
      ...
      dataLead: "绝无主观打分。所有指标直连蒲公英官方与合作数据平台，计算指标仅为基础算术比率。优劣只在本库已收录、同来源、同量级的博主里比位置，不是全平台排名；平台没给的数据保持原样“—”。",
      ...
      groups: {
        ...
        conversion: "收藏点赞比、搜索流量占比（投放前的线索，不等于成交）",
        potential: "读粉比、爆文数与爆文率、推荐流量占比、涨粉率",
        trust: "健康等级、粉丝真实度、活跃粉丝与互动粉丝占比"
      },
      tierTitle: "同量级比排位",
      tierBody: "头部 ≥ 50 万，腰部 5 – 50 万，初级 5 千 – 5 万，素人 300 – 5 千。排位只在本库同来源、同量级的博主里计算，不跨来源比较；分法沿用千瓜通用口径。",
      ...
      values: [
        { title: "不发明综合分数", body: "平台给什么客观指标就呈现什么，好坏只在本库同来源同量级里比相对位置。" },
    ...
    brand: {
      ...
      story: "按条件自动收集博主信息，统一看数口径，在本库同来源同量级里对比表现，直连小红书官方与合作数据平台，为品牌出海提供客观、透明的选人依据。",
      eyebrow: "品牌出海选人系统",
