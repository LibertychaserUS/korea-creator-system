...
export const zhCN: Locale = {
  ...
  kcs: {
    ...
    metricHelp: {
      followers: "平台展示的累计粉丝总数。来自蒲公英/供应商字段，取不到显示 —。",
      followerGrowth: "统计周期内净新增粉丝数。来自蒲公英/供应商字段，取不到显示 —。",
      followerGrowthRate: "新增粉丝 ÷ 统计周期开始时的粉丝数。派生除法计算，取不到显示 —。",
      readFanRatio: "日常笔记阅读中来自已关注粉丝的比例；越低说明公域流量越强。来自蒲公英官方字段，取不到显示 —。",
      activeFanRatio: "近 30 天内在小红书有打开、浏览等活跃行为的粉丝比例。来自蒲公英官方字段，取不到显示 —。",
      engagedFanRatio: "近 30 天内与博主笔记有赞藏评等真实互动的粉丝比例。来自蒲公英官方字段，取不到显示 —。",
      impressionMedian: "统计周期内日常笔记曝光量的中位数（自然公域流量）。来自蒲公英/供应商字段，取不到显示 —。",
      readMedian: "统计周期内日常笔记真实阅读次数的中位数。来自蒲公英/供应商字段，取不到显示 —。",
      interactionMedian: "统计周期内日常笔记（点赞 + 收藏 + 评论）总和的中位数。来自蒲公英/供应商字段，取不到显示 —。",
      likeMedian: "统计周期内日常笔记单篇点赞数的中位数。来自蒲公英/供应商字段，取不到显示 —。",
      collectMedian: "统计周期内日常笔记单篇收藏数的中位数。收藏代表深度种草与购买意向。来自蒲公英/供应商字段，取不到显示 —。",
      commentMedian: "统计周期内日常笔记单篇评论数的中位数。来自蒲公英/供应商字段，取不到显示 —。",
      coopReadMedian: "经蒲公英报备商业合作笔记的阅读量中位数。来自蒲公英官方合作字段，取不到显示 —。",
      coopInteractionMedian: "经蒲公英报备商业合作笔记的点赞、收藏与评论中位数。来自蒲公英官方合作字段，取不到显示 —。",
      engagementRate: "互动中位数 ÷ 阅读中位数（按真实阅读计算，绝不用虚假粉丝数当分母）。来自蒲公英或派生计算，取不到显示 —。",
      retentionRate: "图文笔记 3 秒阅读率或视频笔记 5 秒完播率。来自蒲公英/供应商字段，取不到显示 —。",
      noteCount: "统计周期内在小红书公开发布的笔记总数。来自蒲公英/供应商字段，取不到显示 —。",
      viralCount: "统计周期内达到千赞或五千赞以上的爆文篇数。来自第三方供应商字段，取不到显示 —。",
      viralRate: "爆文数 ÷ 发文数。体现内容爆款稳定性。来自蒲公英或供应商字段，取不到显示 —。",
      priceImage: "蒲公英报备官方图文合作单篇标准报价（人民币）。来自蒲公英官方字段，取不到显示 —。",
      priceVideo: "蒲公英报备官方视频合作单篇标准报价（人民币）。来自蒲公英官方字段，取不到显示 —。",
      cpv: "报价 ÷ 合作阅读中位数，单次真实阅读成本。派生除法计算，取不到显示 —。",
      cpe: "报价 ÷ 合作互动中位数，单次真实互动成本（美妆实操通常 ≤ 3 为优选）。派生除法或官方字段，取不到显示 —。",
      cpm: "报价 ÷ 合作阅读中位数 × 1000，千次真实阅读成本。派生除法计算，取不到显示 —。",
      collectLikeRatio: "收藏中位数 ÷ 点赞中位数。比值越高说明高价值干货与深度种草属性越强。派生计算，取不到显示 —。",
      purchaseIntentCommentRatio: "评论中含「求链接、怎么买、多少钱、色号、已下单」等购买意向词的占比。来自蒲公英官方语义字段，取不到显示 —。",
      trafficSearchRatio: "阅读流量中来自主动搜索的比例；越高代表长尾自然流量与心智沉淀越久。来自蒲公英官方流量结构字段，取不到显示 —。",
      trafficRecommendRatio: "阅读流量中来自发现页/信息流推荐的比例；越高代表爆发推流潜力越大。来自蒲公英官方流量结构字段，取不到显示 —。",
      trafficFollowRatio: "阅读流量中来自博主关注页的比例。来自蒲公英官方流量结构字段，取不到显示 —。",
      readToFollowerRatio: "日常阅读中位数 ÷ 粉丝数。高读粉比代表平台算法正在强推，内容穿透力强。派生计算，取不到显示 —。",
      authenticity: "第三方数据机构根据互动行为特征抽样估算的真实粉丝比例。来自第三方供应商字段，取不到显示 —。",
      coopNoteCount: "博主在小红书平台累计完成的官方报备商业合作笔记总数。来自蒲公英官方字段，取不到显示 —。"
    },
    metricGroup: {
      scale: "规模",
      reach: "传播",
    ...
    band: {
      legend: "数字颜色 = 同源同量级分位；圆点 = 方案高亮阈值",
      cohort: "同源同量级 {n} 人 · {source} · {tier}",
      top10: "同源同量级前 10%",
      top25: "同源同量级前 25%",
      upper: "同源同量级中上 (P50–P75)",
      lower: "同源同量级中下 (P25–P50)",
      bottom: "同源同量级末段 (< P25)",
      none: "样本不足"
    },
    source: {
    ...
    query: {
      title: "筛选方案",
      lead: "筛选方案是一组结构化条件：粉丝量级、健康等级硬门槛、指标阈值、同量级分位与排序。保存后全队统一复用。",
      new: "新建方案",
      unsaved: "未保存方案",
      name: "方案名称",
    ...
    ingest: {
      ...
      run: "开始抓取",
      running: "抓取任务执行中…",
      done: "抓取任务完成：写入 {written} 条，跳过 {skipped} 条重复，失败 {failed} 条",
      fixtureNote: "该数据源未配置接口凭证，系统将返回标准样例数据 (fixture)，用于验证字段映射与界面展示。",
      jobs: "抓取记录",
      jobSource: "数据源",
      jobMode: "模式",
      jobQuery: "参数",
      ...
      noJobs: "还没有抓取记录",
      rawTitle: "原始返回",
      rawLead: "平台返回的原始 JSON 原样保存，便于核对字段映射口径。",
      transform: "转换层",
      transformLead: "每个数据源一张字段映射表，原始 JSON 原样保存，改映射不改代码。"
    },
    landing: {
      navWorkspaces: "工作台",
      navFlow: "流程",
      ...
      workspacesLead: "运营端录入建档，选人端按方案挑库，运维端盯任务队列。各司其职，底层数据与快照完全一致。",
      flowEyebrow: "业务流程",
      flowTitle: "从一条线索，到一份经得起检验的候选名单。",
      steps: [
        { title: "建档", body: "录入显示名、粉丝、报价与合作记录，存成草稿。" },
        { title: "抓取", body: "填参数，从蒲公英 / 千瓜 / 新红拉回博主 JSON，转换层落成统一指标。" },
        { title: "分派", body: "选人端按方案筛、排、勾，一键分派到项目候选名单。" },
        { title: "监控", body: "抓取任务排队、配额游标与重试状态，运维端一目了然。" }
      ],
      dataEyebrow: "数据源头",
      dataTitle: "平台客观数据，零加权黑盒。",
      dataLead: "绝无主观打分。所有指标直连蒲公英官方与千瓜/新红企业接口，派生字段仅为基础算术比率。优劣仅在同数据源、同粉丝量级的群体中对比分位，未取到的数据保持原样“—”。",
      sourcesTitle: "两条路线直连，一层标准转换",
      sources: {
        pugongying: { label: "蒲公英 · 小红书官方", body: "经官方或企业专线网关直连，返回 solar 协议：曝光/阅读/互动中位数、互动率、阅读粉丝占比、图文视频一口价、CPE、健康等级、粉丝画像及合作品牌。" },
        qiangua: { label: "千瓜 · 第三方供应商", body: "企业接口直连：千瓜指数、近 90 天爆文表现、发文频率、涨粉稳定性、粉丝真实度与预估报价。" },
        xinhong: { label: "新红 · 第三方供应商", body: "投放分析数据：图文 / 视频真实 CPE、CPM、新红指数与搜索/推荐流量结构分布。" }
      },
      groupsTitle: "六大规范指标组",
      groups: {
        scale: "粉丝数、近期净涨粉、发文数",
      ...
      tierTitle: "同量级比分位",
      tierBody: "头部 ≥ 50 万，腰部 5 – 50 万，初级 5 千 – 5 万，素人 300 – 5 千。分位只在同一量级同一数据源群体里计算，严禁跨源横向对比。",
      gateTitle: "健康等级是一票否决门槛",
      gateBody: "蒲公英官方健康等级每月 1 日更新。「异常（低活博主）」直接硬门槛排除，不参与任何加权与妥协。",
      transformTitle: "转换层与原始 JSON",
      transformBody: "每个来源配置一张字段映射表，原始 JSON 原样存留备查。调整业务口径改映射，不改动系统核心代码。",
      values: [
        { title: "不发明综合分数", body: "平台给什么客观指标就呈现什么，好坏只在同源同量级里对比相对分位。" },
        { title: "抓取与发布锁定快照", body: "每次抓取留存历史快照，发布后指标固化只读不可篡改，交付名单站得住。" },
        { title: "统一账号按角色开门", body: "基于 TinyShip 统一账号鉴权，平台管理/运营/运维/选人各进专属工作台。" }
      ],
    ...
    brand: {
      ...
      story: "基于参数化爬虫、标准转换层与同量级分位对比，直连蒲公英与第三方数据源，为品牌出海提供客观、透明的博主选人决策。",
      eyebrow: "品牌出海选人系统",
      pillars: "数据源 · 筛选方案 · 项目分派 · 监测",
      loginAside: "基于统一账号体系，按角色直接进入对应工作台。",
      storyExcerpt: "回归客观平台指标，用结构化方案与同量级分位挑选真正有转化力的博主。",
      runLabel: "筛选博主并分派至项目。"
    },
    nav: {
      sources: "数据源",
    ...
    panel: {
      ...
      untitled: "未命名",
      preview: "预览",
      formHint: "保存后生成博主标识与草稿状态；发布后指标快照锁定不可更改。",
      ...
      sources: "数据源",
      batch: "批次",
      poolLead: "仅展示已发布的健康博主；指标与同源同量级分位由转换层直接提供，切换语言不重算。",
      assignTo: "分派到「{name}」",
      ...
      signIn: "登录",
      signInLead: "用工作邮箱登录，按系统角色进入对应工作台。",
      email: "邮箱",
      password: "密码",
      enter: "进入",
      loginError: "邮箱或密码错误，请核对后重试。",
      homeLead: "运营录入、选人挑选与运维监测，底层基于同一套标准转换层与指标快照。",
      opsDesc: "博主建档入库、数据源抓取任务调度与类目管理。",
      selectDesc: "基于筛选方案挑选博主、创建投放项目并分派候选名单。",
      devDesc: "监控抓取任务队列、重试失败作业、检查数据源连接与系统健康度。",
      openOps: "去运营端",
      openSelect: "去选人端",
      openDev: "去运维端",
      denied: "无权访问",
      deniedBody: "当前账号角色无权访问该工作台，请联系平台管理员调整权限。",
      opsHome: "运营工作台",
      createCreator: "录入博主",
      newCreator: "博主建档",
      displayName: "显示名",
      ...
      collaborated: "合作过的",
      neverCollaborated: "没合作过的",
      scoreLocked: "发布快照已锁定，界面与后续抓取不可篡改。",
      draft: "草稿",
      review: "待复核",
      ready: "已规范",
      released: "已发布",
      ...
      openLibrary: "从博主库挑选",
      pool: "博主库",
      emptyPool: "博主库暂无可用博主。请在运营端发起抓取或手动建档。",
      emptyFilter: "当前筛选方案或过滤条件下未匹配到博主。请调整指标阈值或重置筛选。",
      filter: "筛选",
      sort: "排序",
      export: "导出",
      error: "网络请求出现异常，请稍后重试。",
      retry: "重试",
      assign: "分派",
      confirmAssign: "确认分派",
      health: "系统健康",
    ...
    toolbar: {
      ...
      themeDark: "深色",
      themeSystem: "跟着系统",
      ruleFirst: "客观指标，结构化方案，人工确认。"
    },
    overview: {
      eyebrow: "筛选方案",
      title: "按筛选方案检索博主",
      lead: "指标与分位直接来自数据源与转换层，绝不采用主观加权分。",
      statCreators: "博主",
      statTop50: "候选名单",
      statRecommend: "推荐候选",
      statCautious: "审慎考虑",
    ...
    reviews: {
      eyebrow: "合作评估",
      title: "博主评估详情",
      lead: "基于客观指标与同量级分位呈现评估依据，切换语言仅变更界面显示，不改变指标快照。",
      emptyTitle: "当前批次暂无评估记录",
      emptyBody: "选入项目的博主将在此生成评估依据与对接信息。",
      source: {
        success: "数据源规范",
        fallback: "模板说明",
        pending: "待处理",
      ...
      alignment: {
        hard_conflict: "硬门槛排除 (异常)",
        soft_divergence: "指标偏离预警",
        consistent: "符合筛选标准",
        unknown: "未知"
      },
      fields: {
