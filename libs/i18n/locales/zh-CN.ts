...
export const zhCN: Locale = {
  ...
  kcs: {
    landing: {
      ...
      navScoring: "评分",
      previewTitle: "达人库",
      previewMeta: "已发布 · 按综合分排序",
      previewCols: { creator: "达人", grade: "等级", score: "分数", fans: "粉丝" },
      ...
      steps: [
        ...
        { title: "评分", body: "规则引擎按六个维度打分，分级 S / A / B / C，发布后锁定。" },
        { title: "分配", body: "选人在库里筛、排、勾，一键分到项目。" },
        { title: "监测", body: "拉数任务的排队、失败、重试，一眼看全。" }
      ],
      scoringEyebrow: "评分",
      scoringTitle: "规则打分，不靠感觉。",
      scoringLead: "每位达人的综合分由六个维度加权得出，风险项扣分、封顶 100。规则有版本，分数可追溯。",
      dims: {
        screening: { label: "体量", body: "粉丝量级" },
        keywords: { label: "内容", body: "内容关键词命中" },
        koreaBrand: { label: "韩系与品牌", body: "韩国地域与品牌关联" },
        potential: { label: "潜力", body: "体量 × 合作史 × 产出" },
        performance: { label: "表现", body: "互动率、阅读中位数" },
        value: { label: "性价比", body: "千粉报价" }
      },
      gradesTitle: "分级",
      gradeS: "85 分以上，优先接触",
      gradeA: "75 – 84，主力候选",
      ...
      gradeC: "65 以下，先放着",
      riskTitle: "风险扣分",
      riskBody: "画像缺失、标签缺失、合作 ER 过低、报价偏高、排除类型命中，最多扣 10 分。",
      ruleVersion: "规则版本",
      values: [
        { title: "不追逐喧哗", body: "分数来自规则，不来自谁嗓门大。" },
        { title: "只发布一次", body: "发布即锁分，页面改不了，名单才站得住。" },
