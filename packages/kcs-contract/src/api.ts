...
export const API = {
  ...
  opsCreatorTrends: { method: 'GET', path: '/api/ops/creators/:id/trends', perm: 'ops.read' },
  ...
  poolCreatorTrends: { method: 'GET', path: '/api/select/creators/:id/trends', perm: 'select.read' },
